...
import io.github.faizul.user.service.impl.UserServiceImpl;
...
class UserServiceTest {
    ...
    class UpdateProfileTests {
        ...
        void updateProfile_success() {
            ...
            StepVerifier.create(userService.updateProfile(1L, request, null))
                    .assertNext(dto -> {
                        assertThat(dto.id()).isEqualTo(1L);
                    })
                    .verifyComplete();
        ...
        void updateProfile_userNotFound() {
            ...
            StepVerifier.create(userService.updateProfile(999L, request, null))
                    .expectErrorMatches(throwable ->
                            throwable instanceof NoSuchElementException &&
    ...
    class UpdatePasswordTests {
        ...
        void updatePassword_success() {
            ...
            StepVerifier.create(userService.updatePassword(1L, request, null))
                    .verifyComplete();
        ...
        void updatePassword_userNotFound() {
            ...
            StepVerifier.create(userService.updatePassword(999L, request, null))
                    .expectErrorMatches(throwable ->
                            throwable instanceof NoSuchElementException &&
                            throwable.getMessage().equals("User Not Found"))
                    .verify();
