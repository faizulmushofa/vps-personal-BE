package io.github.faizul.storage.uploadunit.tracker.impl;
...
class InMemoryUploadUnitTrackerTest {

    private InMemoryUploadUnitTracker tracker;

    @BeforeEach
    void setUp() {
        tracker = new InMemoryUploadUnitTracker();
    }
