...
class PreviewServiceImplTest {
    ...
    @Mock private StorageNodeFileService fileService;
    ...
    class PreviewPrivateFileTests {
        ...
        void previewPrivateFile_storageNode() {
            ...
            StepVerifier.create(previewService.previewPrivateFile(1L, fileId.toString(), "local", null, null))
                    .assertNext(result -> {
    ...
    class PreviewPublicFileTests {
        ...
        void previewPublicFile_local() {
            ...
            StepVerifier.create(previewService.previewPublicFile("share-token-123", "local", null, null))
                    .assertNext(result -> {
        ...
        void previewPublicFile_google() {
            ...
            StepVerifier.create(previewService.previewPublicFile("share-token-456", "google", null, null))
                    .assertNext(result -> {
