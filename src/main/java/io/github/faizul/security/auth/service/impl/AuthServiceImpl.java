...
import io.github.faizul.security.auth.mapper.AuthMapper;
...
public class AuthServiceImpl implements AuthService {
        ...
        public Mono<Void> logout(String refreshToken, ServerWebExchange exchange) {
                ...
                return currentUserContext.getUserId()
                        .flatMap(userId -> revokeFlow
                                .then(userActivityService.log(userId, "LOGOUT", "Keluar dari aplikasi", exchange))
                                .then())
                        .switchIfEmpty(revokeFlow);
        }
