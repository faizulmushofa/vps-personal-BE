...
import io.github.faizul.setting.repository.AppSettingRepository;
    ...
    private Mono<Void> createSchema() {
        String schema = """
                ...
                CREATE TABLE IF NOT EXISTS file_summaries (
                 ...
                 ALTER TABLE migration_tasks ADD COLUMN IF NOT EXISTS target_folder_id VARCHAR(255);
                  ...
                  ALTER TABLE files ADD COLUMN IF NOT EXISTS folder_id UUID REFERENCES folders(id) ON DELETE SET NULL;
                   ...
                   ALTER TABLE subscription_requests ADD COLUMN IF NOT EXISTS xendit_invoice_id VARCHAR(255) UNIQUE;
                   ALTER TABLE subscription_requests ADD COLUMN IF NOT EXISTS invoice_url VARCHAR(1024);
                   ALTER TABLE subscription_requests ADD COLUMN IF NOT EXISTS external_id VARCHAR(255) UNIQUE;
                   ALTER TABLE subscription_requests ADD COLUMN IF NOT EXISTS amount BIGINT;
